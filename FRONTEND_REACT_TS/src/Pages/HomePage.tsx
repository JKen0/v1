...
import AvatarCard from '../components/gitprofile/avatar-card';
import { Profile } from '../interface/profile';
import DetailsCard from '../components/gitprofile/details-card';
import SkillCard from '../components/gitprofile/skill-card';
import EducationCard from '../components/gitprofile/education-card';
import { GithubProject } from '../interface/github-project';
import GithubProjectCard from '../components/gitprofile/github-project-card';
...
const HomePage = ({ config }: { config: Config }) => {
  ...
  const [theme, setTheme] = useState<string>(getHomeTheme(isDarkMode));
  ...
  useEffect(() => {
    setTheme(getHomeTheme(isDarkMode));
  }, [isDarkMode]);
